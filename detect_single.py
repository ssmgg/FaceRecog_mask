...
flags.DEFINE_string('img_path', './data/img/n00000019/n00000010_00000018.JPEG', 'path to input image')
...
def main(_argv):
    ...
    # save_img_path = os.path.join('out_' + os.path.basename(FLAGS.img_path).split('.')[0] + '_half.jpg')
    ...
    for prior_index in range(len(outputs)):
        ...
        cv2.imwrite('./{}_{}.jpg'.format(os.path.basename(FLAGS.img_path).split('.')[0], prior_index), img)
